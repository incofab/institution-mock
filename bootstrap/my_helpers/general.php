...
/**
 * Simple method to return operation response data
 * @param boolean $successful
 * @param string $message
 * @param mixed $result
 * @return array []
 */
function ret($successful, $message, $result = null, $val = null)
{
    return [
...
function retF($message, $result = null, $val = null)
{
    return ret(false, $message, $result, $val);
}
function retS($message, $result = null, $val = null)
{
    return ret(true, $message, $result, $val);
}
...
function getAddr($routeName = null, $params = '')
{
    ...
    if (!empty($routesArr[$routeName]) || !empty($routesArrAPI[$routeName])) {
        ...
        throw new Exception(
            "Route: ($routeName) not found in route collections",
        );
    }
}
