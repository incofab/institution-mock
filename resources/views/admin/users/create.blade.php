<?php
$title = 'Admin - Add Administrative user'; ?>
	...
	<div class="page-display">
		...
		<form method="POST" action="" name="register" >
			...
			<div class="form-group">
				...
				<input type="text" id="" name="<?= USERNAME ?>" value="<?= getValue(
    $post,
    USERNAME,
) ?>" 
			...
			<div class="form-group">
				...
				<input type="text" id="" name="<?= EMAIL ?>" value="<?= getValue(
    $post,
    EMAIL,
) ?>" 
			...
			<div class="form-group">
				...
				<select name="<?= LEVEL ?>" id="" class="form-control" required="required">
					...
					<option value="10" <?= markSelected(
         '10',
         array_get($post, LEVEL),
     ) ?> >10</option>
				</select>
			</div>
			@endif
