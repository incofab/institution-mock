...
<header class="app-header">
	<a class="app-header__logo text-truncate" href="{{instRoute('dashboard')}}">{{config('app.name')}}</a>
	<!-- Sidebar toggle button-->
	<a class="app-sidebar__toggle" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"></a>
	<!-- Navbar Right Menu-->
	<ul class="app-nav">
		<li class="app-search"><input class="app-search__input" type="search"
			placeholder="Search">
		...
		<li class="dropdown"><a class="app-nav__item" href="#"
			...
			<ul class="dropdown-menu settings-menu dropdown-menu-right">
				<li><a class="dropdown-item" href="page-users.html"><i
